...
Dim i As Byte
      ...
      strGpTopic(0) = "รหัสแฟ้มระบบ"
      strGpTopic(1) = "ชื่อแฟ้มระบบ"
...
Dim bytConSave As Byte
    ...
    If cmbLevel.Text.Trim.ToString <> "" Then 'Level
            ...
            If txtSurName.Text.Trim.ToString <> "" Then 'ชื่อนามสกุล
                    ...
                    If txtUser.Text.Trim.ToString <> "" Then 'User Id
                            ...
                            If txtPass.Text.Trim.ToString <> "" Then 'PassWord
                                        ...
                                        If bytConSave = 6 Then
                                                    Select Case Me.Text
                                                           ...
                                                           Case Is = "เพิ่มข้อมูลผู้ใช้งาน"
                                                                      SaveNewRecord()
                                                           Case Is = "แก้ไขข้อมูลผู้ใช้งาน"
                                                                      SaveEditRecord()
                                                     End Select
                                        Else
                                            txtSurName.Focus()
                            ...
                            Else
                                ...
                                MsgBox("โปรดระบุ PassWord ก่อนบันทึกข้อมูล", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "Please Input Data First!")
                                txtPass.Focus()
                    ...
                    Else
                        ...
                        MsgBox("โปรดระบุ User Id ก่อนบันทึกข้อมูล", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "Please Input Data First!")
                        txtUser.Focus()
            ...
            Else
                ...
                MsgBox("โปรดระบุชื่อ-นามสกุล ก่อนบันทึกข้อมูล", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "Please Input Data First!")
                txtSurName.Focus()
    ...
    Else
        ...
        MsgBox("โปรดระบุระดับยูสเซอร์ ก่อนบันทึกข้อมูล", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "Please Input Data First!")
        cmbLevel.Focus()
         ...
         With Rsd
                 ...
                 .Open(strSqlCmdSelc, Conn, , , )
                  ...
                  If .RecordCount <> 0 Then
                          ...
                          MsgBox("ข้อมูล User Id : " & strUser & " มีอยู่แล้ว!" & vbNewLine _
          ...
          If bytHaveData = 1 Then
                    ...
                    lblComplete.Text = strUser  'บ่งบอกว่าบันทึกข้อมูลสำเร็จ
