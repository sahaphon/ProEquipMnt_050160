...
Public Class frmRptDelvApprove
 Dim cryRpt As New ReportDocument
 Dim strUser As String
 Dim intWidth As Integer

Private Sub frmRptDelvApprove_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
 ...
 Dim ds As New DataSet
     ...
     End With
        ...
        strSqlSelc = "SELECT  * FROM v_rpt_delvr2 (NOLOCK)" _
                            ...
                            & " ORDER BY int_size ASC,size_act ASC"
        ...
        With Rsd
            ...
            .Open(strSqlSelc, Conn, , , )
             ...
             If .RecordCount <> 0 Then
                ...
                If .Fields("ps01_usr").Value.ToString <> "" Then           'ตรวจสอบว่า ps01_result = 1 หรือไม่
 ...
 Dim strDate As String = datSave.Date.ToString("yyyy-MM-dd")
     ...
     End With
          ...
          strSqlCmd = "UPDATE delv_approve SET app_sta = '" & "0" & "'" _
                    ...
                    & "," & "ps04_usr = '" & "" & "'" _
                    & "," & "note = '" & ReplaceQuote(txtName.Text.ToUpper.Trim) & "'" _
...
Private Sub btnAcp1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAcp1.Click
  ...
  If frmMainPro.lblLogin.Text = "MALIWAN" Then          'ตรวจสอบชื่อผู้ใช้
...
Private Sub btnAcp4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
     ...
     Conn.Execute(strSqlSelc)
       ...
       With Rsd
            ...
            If .RecordCount <> 0 Then
               ...
               strDept = .Fields("rvc_dep_nm").Value.ToString.Trim       'แผนกที่รับ
...
Private Sub lnkSave_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkSave.LinkClicked
  ...
  SaveApprove_ps01()     'เพิ่มรายการใน table approve_delv
  ClearData(1)           'เคลี่ยร์ข้อมูลใน tmp_rpt_delv2 
  PrePrintdata()
  Viewdata()
...
Private Sub lnkCancle_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkCancle.LinkClicked
